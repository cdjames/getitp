...
var casper = require("casper").create({
    ...
    // logLevel: "debug",   // uncomment for testing
    clientScripts:  [
        // 'includes/jquery.js'    // This script will be injected; works from command line
        '/usr/local/casperjs/includes/jquery.js'    // This script will be injected; works from bash script
    ],
